...
// EastAsianWidth.txt (ea F/W/H ranges for LB30). DO NOT EDIT BY HAND — run
...
console.log(`Wrote ${ranges.length} LB ranges (${classNames.length} classes) + ${eaRanges.length} EA-wide ranges to ${outFile}`);
