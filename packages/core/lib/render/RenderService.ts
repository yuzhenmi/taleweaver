...
export default class RenderService {
    ...
    getDocSize() {
        return this.renderEngine.getDoc().getSize();
    }
    ...
    getTextStyleBetween(from: number, to: number) {
        ...
        while (fromInlineRenderNode === null) {
            ...
            const fromInlinePosition = fromPosition.getLeaf().getParent()!;
            const renderNode = fromInlinePosition.getNode();
            if (!(renderNode instanceof InlineRenderNode)) {
                return null;
            }
            fromInlineRenderNode = renderNode;
        ...
        while (toInlineRenderNode === null) {
            ...
            const toInlinePosition = toPosition.getLeaf().getParent()!;
            const renderNode = toInlinePosition.getNode();
            if (!(renderNode instanceof InlineRenderNode)) {
                return null;
            }
            toInlineRenderNode = renderNode;
