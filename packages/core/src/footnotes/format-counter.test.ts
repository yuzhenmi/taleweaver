...
describe("formatCounter — decimal", () => {
  it("formats 1-based integers with a trailing dot (numbered-list convention)", () => {
...
describe("formatCounter — lower-roman", () => {
  it("formats the i..xii sequence (trailing dot)", () => {
    const expected = [
      "i.", "ii.", "iii.", "iv.", "v.", "vi.",
...
describe("formatCounter — upper-alpha (bijective base-26)", () => {
  it("formats A..Z then AA (trailing dot)", () => {
