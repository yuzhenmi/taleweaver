...
export interface IBlockRenderNode extends IRenderNode<IDocRenderNode, IInlineRenderNode> {}

export abstract class BlockRenderNode extends RenderNode<IDocRenderNode, IInlineRenderNode>
