/**
 * Regeneration-drift guard: the committed `bidi-class-table.ts` must byte-equal
 * a fresh run of `scripts/gen-uax9-table.ts`. This catches hand-edits to the
