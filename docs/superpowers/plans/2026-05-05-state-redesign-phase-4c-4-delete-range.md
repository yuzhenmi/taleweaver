...
export function deleteRange(state: State, span: Span): OperationResult {
  ...
  // generic "block ... not found" message that would otherwise leak
  // through the normalizeSpan → comparePositions path. Same architectural
  // pattern as Phase 4c-1's applyAttrsToRange fix.
