...
| E-E: #172 LineBox-canonical refactor | 🟡 in progress; spec landed | spec: `cc6e0d9` | Spec at `docs/superpowers/specs/2026-05-23-linebox-canonical-anchor-design.md`. Splits into 7 sub-tasks (E-E.1 through E-E.7). E-E.1 = add LineBox fields + thread through IFC + `rebuildBoxWithOffsets` + `rebaseLine`. E-E.2 = `collectLineBoxes` helper. E-E.3–6 = migrate hit-test / cursor-position / selection-geometry / line-navigation one at a time. E-E.7 = remove synthetic-strut + delete `editor/layout-utils.ts`. Two reviewer passes on the spec (3 critical + 5 important issues fixed). |
